...
training_xml_path = os.path.join(faces_folder, "focinho_hog.xml")
...
# dlib.
dlib.train_simple_object_detector(training_xml_path, "../biblioteca/detector_focinhos.svm", options)
...
print("Training accuracy: {}".format(
    dlib.test_simple_object_detector(training_xml_path, "../biblioteca/detector_focinhos.svm")))
# However, to get an idea if it really worked without overfitting we need to
# run it on images it wasn't trained on.  The next line does this.  Happily, we
# see that the object detector works perfectly on the testing images.
print("Testing accuracy: {}".format(
    dlib.test_simple_object_detector(testing_xml_path, "../biblioteca/detector_focinhos.svm")))
...
images = [dlib.load_rgb_image(faces_folder + '/20201104_131526 (2).jpg'),
          dlib.load_rgb_image(faces_folder + '/20201104_131526 (2).jpg')]

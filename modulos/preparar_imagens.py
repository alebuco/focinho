...
def salvarImgensTreinamento(dir_atual, pasta_destino):

    caminhosImangens = [os.path.join(dir_atual, f) for f in os.listdir(dir_atual)]
    num_imagem = 1
    for imagem in caminhosImangens:
...
salvarImgensTreinamento(pasta, pasta_destino)